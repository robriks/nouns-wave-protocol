...
contract RendererTwo {
    ...
    function addDefs() private pure returns (string memory) {
        return string.concat(
            ...
            "</linearGradient>",
            "<linearGradient id='baseGradient' x1='100%' y1='0%' x2='0%' y2='100%'>",
            "<stop offset='0%' style='stop-color:#385EFE;stop-opacity:1' />",
            "<stop offset='30%' style='stop-color:#2750FB;stop-opacity:1' />",
            "<stop offset='60%' style='stop-color:#254EFB;stop-opacity:1' />",
            "<stop offset='100%' style='stop-color:#162E95;stop-opacity:1' />",
            "</linearGradient>",
    ...
    function constructSVG() private view returns (string memory) {
        return string.concat(
                ...
                " xmlns:xlink='http://www.w3.org/1999/xlink'>",
                   ...
                   "</style>",
                   addDefs(),
                   "<rect width='592' height='352' x='4' y='4' rx='10' fill='#254EFB' stroke='#00000030' stroke-width='4' rx='10' />",
                   "<rect width='592' height='352' x='4' y='4' fill='url(#baseGradient)' rx='10' />"
            );
    }

    function generateTitle(uint256 tokenId) private view returns (string memory svg) {
        return string.concat(
                "<text x='20' y='70' font-size='48' class='polyDisp' fill='#FFFFFF' letter-spacing='1.75'>IDEA ",
                tokenId.toString(),
                "</text><text x='20' y='95' font-size='20' class='polyDisp' fill='#FFFFFF' letter-spacing='1.20''>WAVE 12</text>"
            );
    }
    ...
    function addFooter(uint256 tokenId) private view returns (string memory) {
        return string.concat(
            ...
            "<text x='16' y='40' font-size='14' class='polyDisp' fill='#00000030' dominant-baseline='middle'>SUPPORT:</text>",
            "<rect x='90' y='15' width='100' height='50' fill='#E9EDFE' rx='4' />",
            "<text x='100' y='42' font-size='16' class='polyDisp' fill='#00000060' dominant-baseline='middle'>0.34 ETH</text>",
            "<rect x='195' y='15' width='100' height='50' fill='#E9EDFE' rx='4' />",
            "<text x='205' y='42' font-size='16' class='polyDisp' fill='#00000060' dominant-baseline='middle'>12 MINTS</text>",
            "<text x='403' y='40' font-size='14' class='polyDisp' fill='#00000030' dominant-baseline='middle'>STATUS:</text>",
            "<rect x='465' y='15' width='100' height='50' fill='#E9EDFE' rx='4' />",
            "<text x='475' y='42' font-size='16' class='polyDisp' fill='#00000060' dominant-baseline='middle'>PASSED</text>",
            "</g>"
        );
    }
    ...
    function addBadgeIcon(uint256 headId) private view returns (string memory) {
        ...
        return string.concat(
            "<g transform='translate(482, 68) scale(.20) rotate(-20)'>",
            headSVG,
            "</g>"
        );
    }
    ...
    function addBadgeText(uint256 tokenId) private view returns (string memory) {
        return string.concat(
            "<text x='0' y='0' font-size='12' fill='#FFF' class='polyText'>",
                "<textPath href='#top-semi-circle' startOffset='40%' text-anchor='middle'>I support idea 123</textPath>",
            "</text>",
            "<text x='0' y='0' font-size='12' fill='#FFF' class='polyText'>",
                "<textPath href='#bottom-semi-circle' startOffset='40%' text-anchor='middle'>I support idea 123</textPath>",
            "</text>"
        );
    }
