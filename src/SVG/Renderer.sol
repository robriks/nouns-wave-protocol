...
contract Renderer is IRenderer {
    ...
    function generateSVG(uint256 tokenId) public view returns (string memory svg) {
        return string.concat(_constructSVG(), _addBadge(tokenId), "</svg>");
    }
    ...
    function _addDefs() private pure returns (string memory) {
    ...
    // 90x90
    function _constructSVG() private view returns (string memory) {
        return string.concat(
    ...
    function _addBadge(uint256 tokenId) private view returns (string memory) {
        ...
        return string.concat(
            ...
            _addBadgeText(tokenId),
            _addBadgeIcon(config.partId),
            "</g>",
    ...
    function _addBadgeIcon(uint256 headId) private view returns (string memory) {
    ...
    function _addBadgeText(uint256 tokenId) private pure returns (string memory) {
        return string.concat(
